...
public class EbaySale implements SaleInsights {
    ...
    public SaleAggregate getSaleInsights(DataProvider dataProvider, int year) throws IOException, AnalyticsException {
        ...
        try {
            ...
            while ((nextRecord = reader.readNext()) != null) {
                ...
                String retrievedate = nextRecord[3];

                String status = nextRecord[2];
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MM/dd/yyyy");

                LocalDate tod = LocalDate.parse(retrievedate, formatter);

                month = tod.getMonthValue();
                checkyear = tod.getYear();

                if (month == 1 && checkyear == year && !status.equalsIgnoreCase("failed"))

                {

                    double sale = Double.parseDouble(nextRecord[4]);
                    janMonth = janMonth + sale;

                    map.put(1, janMonth);
                }

                else if (month == 2 && checkyear == year && !status.equalsIgnoreCase("failed"))
                ...
                else if (month == 3 && checkyear == year && !status.equalsIgnoreCase("failed"))
                ...
                else if (month == 4 && checkyear == year && !status.equalsIgnoreCase("failed"))
                ...
                } else if (month == 5 && checkyear == year && !status.equalsIgnoreCase("failed"))

                {
                    ...
                    map.put(5, mayMOnth);
                } else if (month == 6 && checkyear == year && !status.equalsIgnoreCase("failed"))

                {
                    ...
                    map.put(6, JuneMonth);
                } else if (month == 7 && checkyear == year && !status.equalsIgnoreCase("failed"))
                ...
                } else if (month == 8 && checkyear == year && !status.equalsIgnoreCase("failed"))

                {
                    ...
                    map.put(8, Agust);
                } else if (month == 9 && checkyear == year && !status.equalsIgnoreCase("failed"))
                ...
                else if (month == 10 && checkyear == year && !status.equalsIgnoreCase("failed"))

                {
                    ...
                    map.put(10, oct);
                } else if (month == 11 && checkyear == year && !status.equalsIgnoreCase("failed"))

                {
                    ...
                    map.put(11, nov);
                } else if (month == 12 && checkyear == year && !status.equalsIgnoreCase("failed"))
