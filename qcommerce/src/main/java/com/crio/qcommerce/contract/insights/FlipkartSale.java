...
public class FlipkartSale implements SaleInsights {
    ...
    public SaleAggregate getSaleInsights(DataProvider dataProvider, int year) throws IOException, AnalyticsException {
        ...
        try {
            ...
            while ((nextRecord = reader.readNext()) != null) {
                ...
                if (month == 1 && checkyear == year && !status.equalsIgnoreCase("pending"))
                ...
                else if (month == 2 && checkyear == year && !status.equalsIgnoreCase("pending"))
                ...
                else if (month == 3 && checkyear == year && !status.equalsIgnoreCase("pending"))
                ...
                else if (month == 4 && checkyear == year && !status.equalsIgnoreCase("pending"))
                ...
                } else if (month == 5 && checkyear == year && !status.equalsIgnoreCase("pending"))

                {
                    ...
                    map.put(5, mayMOnth);
                } else if (month == 6 && checkyear == year && !status.equalsIgnoreCase("pending"))

                {
                    ...
                    map.put(6, JuneMonth);
                } else if (month == 7 && checkyear == year && !status.equalsIgnoreCase("pending"))
                ...
                } else if (month == 8 && checkyear == year && !status.equalsIgnoreCase("pending"))

                {
                    ...
                    map.put(8, Agust);
                } else if (month == 9 && checkyear == year && !status.equalsIgnoreCase("pending"))
                ...
                else if (month == 10 && checkyear == year && !status.equalsIgnoreCase("pending"))

                {
                    ...
                    map.put(10, oct);
                } else if (month == 11 && checkyear == year && !status.equalsIgnoreCase("pending"))

                {
                    ...
                    map.put(11, nov);
                } else if (month == 12 && checkyear == year && !status.equalsIgnoreCase("pending"))
